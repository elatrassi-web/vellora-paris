...
BASE_URL = "https://3125tiger.x.yupoo.com/categories/3902792?page="
...
def main():
    ...
    df.to_csv('yupoo_categorie_3902792.csv', index=False)
    print("CSV saved as yupoo_categorie_3902792.csv")
